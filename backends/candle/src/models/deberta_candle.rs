...
impl XSoftmax {
    fn apply(input: &Tensor, mask: &Tensor, dim: D, device: &Device) -> Result<Tensor> {
        ...
        // Match reference tensor creation pattern for the minimum value.
        // We retain .to_dtype() to ensure the implementation remains robust for f16/bf16.
        ...
        // Match reference tensor creation pattern for zeros to nullify padded token probabilities.
